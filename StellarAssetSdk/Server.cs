...
public class Server
{
    ...
    public static Asset Usdc(Account issuer)
    {
        return Usdc(issuer.AccountId);
    }

    public static Asset Usdc(string issuer)
    {
        return new AssetTypeCreditAlphaNum12("USDC", issuer);
    }
